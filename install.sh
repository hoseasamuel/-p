...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/hoseasamuel/-p/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
while true; do
  ...
  echo -e "                                                      
                 "
  echo -e "${RED} 🇼 🇪 🇱 🇨 🇴 🇲 🇪 ${NC}"                
  echo -e "${RED}• Auto Installer Miracle ${NC}"
  echo -e "${RED}• Telegram : Miracle ${NC}"
  echo -e "${RED}• Creadit  : Miracle  ${NC}"
  echo -e "${RED}• Support by Miracle  ${NC}"
  echo -e "                                                                     "
